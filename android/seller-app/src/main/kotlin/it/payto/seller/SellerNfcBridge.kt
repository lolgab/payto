...
object SellerNfcBridge {
    private const val TAG = "SellerNfcBridge"
    ...
    /** Registra il servizio HCE come preferito in foreground (evita AppChooser su Realme/Oppo). */
    fun syncPreferredService(activity: Activity) {
        ...
        if (!cardEmulation.isDefaultServiceForCategory(
            ...
            // Non default: serve setPreferredService mentre l'activity è resumed.
